...
description: Use for UR12e release packaging, validation, and handoff under the local engineering profile. Cloud Deploy orchestration remains reference-only unless the user explicitly requests Google Cloud delivery.
metadata:
  version: "0.1.0"
---
